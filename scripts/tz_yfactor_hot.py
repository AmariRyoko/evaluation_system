...
class yfactor(object):
    def __init__(self):
        ...
        self.pub_vol_start = rospy.Publisher("topic_sub_vol_start", Float64, queue_size = 1)
        self.pub_vol_stop = rospy.Publisher("topic_sub_vol_stop", Float64, queue_size = 1)
        self.pub_val_start = rospy.Publisher("topic_sub_val_start", Float64, queue_size = 1)
        self.pub_val_stop = rospy.Publisher("topic_sub_val_stop", Float64, queue_size = 1)
